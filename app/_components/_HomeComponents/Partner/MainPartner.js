      ...
      <div className="container">
        <div className="partner-info">
          ...
          <div className="brands">
            ...
            >
              <Image src={College} alt="logo" width={252} priority />
            </div>
            <div
            ...
            >
              <Image src={Pearsons} alt="logo" width={205} priority />
            </div>
            <div
              ...
              data-aos-duration="2000"
            >
              <Image src={Aiaa} alt="logo" width={170} priority />
            </div>
            <div
            ...
            >
              <Image src={Cognia} alt="logo" width={216} priority />
            </div>
